...
app.post('/clients', (req, response) => {
  client.query("INSERT INTO " +  
    "salesforce.contact(Apellidos__c, Birthdate, CargoEmpresa__c, Ciudad_Tutor__c, Ciudad_de_Trabajo__c, Codigo_Cliente__c, CreatedDate," +
      ...
      "Subsidiaria__c, SystemModstamp, TipoIdentificacion__c, Tipo_Tarjeta__c, hed__Gender__c, Contact_Record_Id__c)" +
    ...
    req.body.SystemModstamp, req.body.TipoIdentificacion__c, req.body.Tipo_Tarjeta__c, req.body.hed__Gender__c, req.body.Contact_Record_Id__c], 
    ...
    (err, data) => {
      if (err) {
        ...
        response.send(req.body.Contact_Record_Id__c);
      }
  });
});
...
app.post('/factura', (req, response) => {
  client.query("INSERT INTO" + 
    ...
    "Id, IsDeleted, Location__c, Name, Orden_Exenta__c, Raz_n_Social__c, Registro_SAG__c, Subsidiaria__c, SystemModstamp, Factura_Record_Id__c)" +
    ...
    req.body.Registro_SAG__c, req.body.Subsidiaria__c, req.body.SystemModstamp, req.body.Factura_Record_Id__c], 
    ...
    (err, data) => {
      if (err) {
        ...
        response.send(req.body.Factura_Record_Id__c);
      }
  });
});
...
app.post('/productos', (req, response) => {
  client.query("INSERT INTO" + 
    ...
    "Segmento_de_Negocio__c, Sub_Categoria__c, SystemModstamp, Valor_Unitario__c, Producto_Record_Id__c)" +
    ...
    req.body.Producto_Record_Id__c], 
    ...
    (err, data) => {
      if (err) {
        ...
        response.send(req.body.Producto_Record_Id__c);
      }
  });
});
